...
def white_move_player(initial_move, new_move, chessboard, piece_to_promote = False):

    # # This is unnecessary when two players play the game, as the move builds work on eachother, but when we run it on
    # # the counter, then it is a must, as otherwise different positions will get mixed up.
    ...
    while not legal_move:
        ...
        for element in chessboard.possible_moves_white:
